...
07:30まではやや遅いながらも当初のボトルネックの原因特定までいき、そこまではよかったのですが、その後4時間もかけてエラーや自分のしこんだソースコードのバグと戦ううちにどんどん時間が溶けてなくなりました。
...
nginxのaccess.logより、全てのレスポンスが極端に早くなったことはわかりますが、当然ながらHTMLの中身が不正になっているのでスコアがあがっていないようです。
...
データベースを見るとentryテーブルのdescriptionカラムにプレーンテキストが入っています。そしてプレーンテキストの中の単語に、その単語が別のエントリとして用意されていればハイパーリンクを付けることが期待されているようです。はてなキーワードみたいなものですね！
...
- 1) ベンチマーカーがどうやってリンクを調べているかを把握して、抜け道をさくぐｒ
